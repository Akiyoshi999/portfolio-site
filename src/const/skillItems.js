...
const skillSection = {
  title: "My Skill Set",
  body: `私がこれまでに習得してきたスキルをテーブル形式に分野毎にまとめました。
深く理解しているわけではありませんが、フロントエンド、バックエンド、インフラ、OSなどの知識を幅広く持っています。多様な角度から物事を見ることが私の強みです。
色々な知識に触れていくうちにインフラや開発の分野に強く興味を惹かれたので、今後はその分野の仕事に携わりたいと考えています。`,
...
const infraSkills = {
  ...
  subheader: `AWSはこのHPの作成や、資格を勉強した際に多くのサービスを使用しているので、一通り使えます。`,
  header: commonHead,
  skills: [
    ["AWS", <Rating value={3} />],
